...
contract IndependentSlotsChannelFinalizer is SlotsImplementation, SafeMath, Utils {
    ...
    function IndependentSlotsChannelFinalizer(address _slotsHelper) {
        owner = msg.sender;
    ...
    isSlotsChannelManagerSet returns (bool) {
        ...
        // Execute only if channel is ready, activated and not finalized
        if (!slotsChannelManager.isChannelFinalizeable(id)) revert();
